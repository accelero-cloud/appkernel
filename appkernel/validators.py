...
class ValidationException(AppKernelException):
    def __init__(self, message: str, validable_object: Any = None, validator_type: Any = None) -> None:
...
class Validator:
    ...
    def __init__(self, validator_type: ValidatorType, value: Any = None, message: str | None = None) -> None:
        self.type = validator_type.name if isinstance(validator_type, ValidatorType) else validator_type
        self.value = value
        self.message = message

    def validate_objects(self, parameter_name: str, instance_parameters: dict[str, Any]) -> None:
        self.validate(parameter_name, instance_parameters.get(parameter_name))

    def validate(self, parameter_name: str, validable_object: Any) -> None:
        """
...
class Min(Validator):
    def __init__(self, minimum: int | float) -> None:
        super().__init__(ValidatorType.MIN, minimum)
...
class Max(Validator):
    def __init__(self, maximum: int | float) -> None:
        super().__init__(ValidatorType.MAX, maximum)
...
#         super().__init__(ValidatorType.RANGE, minimum)
...
class Unique(Validator):
    def __init__(self) -> None:
        super().__init__(ValidatorType.UNIQUE)
...
class NotEmpty(Validator):
    ...
    def __init__(self) -> None:
        super().__init__(ValidatorType.NOT_EMPTY)
...
class Past(Validator):
    def __init__(self) -> None:
        super().__init__(ValidatorType.PAST)
...
class Future(Validator):
    def __init__(self) -> None:
        super().__init__(ValidatorType.FUTURE)
